    ...
    <div class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            ...
            <div class="modal-body">
                ...
                <tbody>
                    <form action="" method="POST">
                        <tr>
                            <td>Enter Booking Date</td>
                            <td><input type="text" class="form-control" name="u_b_date" value="<?php echo $row['b_date']; ?>"></td>
                        </tr>
                        <tr>
                            <td>Enter First Name</td>
                            <td><input type="text" class="form-control" name="u_firstname" value="<?php echo $row['firstname']; ?>"></td>
                        </tr>
                        <tr>
                            <td>Enter Last Name</td>
                            <td><input type="text" class="form-control" name="u_lastname" value="<?php echo $row['lastname']; ?>"></td>
                        </tr>
                        <tr>
                            <td>Enter your Email</td>
                            <td><input type="text" class="form-control" name="u_email" value="<?php echo $row['email']; ?>"></td>
                        </tr>
                        <tr>
                            <td>Enter your contact Number</td>
                            <td><input type="text" class="form-control" name="u_contact" value="<?php echo $row['contact']; ?>"></td>
                        </tr>
                    </form>
                </tbody>
            </table>
            ...
            <div class="modal-footer">
                ...
                <button type="submit" class='btn btn-info' name="u_update">Update</button>
            </div>
            </div>
        </div>
    </div>
